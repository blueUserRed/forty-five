...
class Revolver(
    ...
    private val background: Promise<Drawable> = FortyFive.resourceManager.request(this, screen.lifetime, backgroundHandle)

    private val iceShader: Promise<BetterShader> by lazy {
        FortyFive.resourceManager.request(this, screen.lifetime, "ice_shader")
    }
