...
interface DropShadow {
    ...
    fun doDropShadow(batch: Batch?, screen: RenderableScreen, drawable: Drawable, actor: Actor)
...
class BakedDropShadow(
    ...
    override fun doDropShadow(batch: Batch?, screen: RenderableScreen, drawable: Drawable, actor: Actor) =
...
class SquareDropShadow(
    ...
    private inline fun doDropShadow(batch: Batch?, screen: RenderableScreen, drawer: () -> Unit) {
        batch ?: return
